                  ...
                  <div class="hometop-quickfinder">
                    <div class="hometop-quickfinder-causes">
                      ...
                      <select name="cause_filter" style="display: none;">
                        ...
                        <option value="33">Animals</option>

                        <option value="34">Arts &amp; Culture</option>

                        <option value="46">Black Male Achievement</option>

                        <option value="35">Civil Rights</option>

                        <option value="45">Community &amp; Economic Development</option>

                        <option value="41">Disaster Relief</option>

                        <option value="42">Disease &amp; Medical Research</option>

                        <option value="8">Education</option>

                        <option value="43">Employment Services</option>

                        <option value="9">Environment</option>

                        <option value="40">Health &amp; Nutrition</option>

                        <option value="13">Housing &amp; Homelessness</option>

                        <option value="37">Human Services</option>

                        <option value="21">International Affairs</option>

                        <option value="36">Justice &amp; Legal Services</option>

                        <option value="47">Maternal Health</option>

                        <option value="39">Philanthropy &amp; Capacity Building</option>

                        <option value="38">Religion &amp; Spirituality</option>

                        <option value="29">Science &amp; Technology</option>

                        <option value="27">Women's Issues </option>

                        <option value="44">Youth Development</option>
                    ...
                    <div class="hometop-quickfinder-skills">
                      ...
                      <select name="skill_filter" style="display: none;">
                        ...
                        <option value="21">Branding</option>

                        <option value="19">Business Development</option>
                        ...
                        <option value="29">Database Administration</option>

                        <option value="24">Digital Marketing</option>

                        <option value="26">Entrepreneurship</option>

                        <option value="6">Finance</option>

                        <option value="16">Fundraising</option>

                        <option value="5">Graphic Design</option>

                        <option value="7">Human Resources</option>

                        <option value="30">Information Technology</option>
                        ...
                        <option value="14">Strategy Consulting</option>

                        <option value="33">Web Design</option>

                        <option value="34">Web Development</option>

                        <option value="23">Writing</option>
              ...
              <div class="container">
                ...
                <div class="panel-projectcard-container clearfix slick-initialized slick-slider">
                  ...
                  <section class="case-studies block clear">
                    ...
                    </div><!-- banner-home-enterprisesolution -->
                ...
                <script type="text/javascript" src="./Catchafire - Skills-Based Volunteer Matching_files/jquery.simpletextrotator.js"></script>
                <script>
                  $(".rotate").textrotator({
                    animation: "flipUp",
                    separator: ";",
