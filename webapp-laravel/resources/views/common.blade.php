...
<style>#page>header:before{ background-color:#16C287 }
...
<body class="homepage">
  ...
  <div id="page" class="clear">
    ...
    <header class="header-main">
      <div class="container">
        <h1 id="logo-catchafire"><a href="{{ url('/index') }}">iVolunteer</a></h1>
        <ul class="nav-main">
          <li>
            <a href="{{ url('/process') }}">
              <h3>How it works</h3>
          ...
          @else
          <li class="login authenticated">
            <div class="profiledropdown-container" tabindex="100">
              <img class="profile-image" width="30" height="30" src="{{ asset('/img/') }}/{{Auth::user()->profile->image}}">
              <i></i>
              <div class="profiledropdown-active">
                <section class="profiledropdown-group">
                  <a href="{{ url('/dashboard') }}">{{ Auth::user()->name }}<br>{{Auth::user()->profile->last_name}}</a>
                </section><!-- profiledropdown-group -->
                <section class="profiledropdown-group">
                  <a href="{{ url('/dashboard') }}">Dashboard</a>
                  <a href="{{ url('/listing') }}">Project Listing</a>
                </section><!-- profiledropdown-group -->
                <section class="profiledropdown-group">
                  <a href="{{ url('/auth/logout') }}">Logout</a>
                </section><!-- profiledropdown-group -->
              </div><!-- profiledropdown-active -->
            </div><!-- profiledropdown-container -->
    ...
    <footer>
      <div class="container">
        <nav class="internal">
          <hgroup>
            <h1>iVolunteer</h1>
            <h2>Where Talent meets purpose</h2>
          </hgroup>
          <ol>
        ...
        <section class="team">
          ...
          <a href="{{ url('/team') }}" class="button small">Meet the team</a>

          <div class="avatars">


            <a href="{{ url('/team') }}#aunn"><img src="{{ asset('/img/dev.jpg') }}" width="60" height="60" alt=""></a>

            <a href="{{ url('/team') }}#zaheer"><img src="{{ asset('/img/dada.jpg') }}" width="60" height="60" alt=""></a>

            <a href="{{ url('/team') }}#shiza"><img src="{{ asset('/img/shiza.jpg') }}" width="60" height="60" alt=""></a>

            <a href="{{ url('/team') }}#hunain"><img src="{{ asset('/img/hun.jpg') }}" width="60" height="60" alt=""></a>
