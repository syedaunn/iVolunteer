    ...
    <section class="register-login">
        <div class="forms">
            ...
            <div class="login">
                ...
                <form onsubmit="return integrateAxes();" role="form" method="POST" id="login-form" action="{{ url('/auth/login') }}" class="js-disable-on-submit" autocomplete="off">
                    ...
                    <p class="form-field">
                        ...
                        <input id="id_email"  value="{{ old('email') }}" maxlength="200" name="email" type="email">
